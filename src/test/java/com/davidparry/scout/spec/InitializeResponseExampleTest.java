...
//    @Test
//    public void testInitializeWithAllParameters() {
//        // Arrange
//        String protocolVersion = "1.0";
//        Map<String, Object> experimental = new HashMap<>();
//        experimental.put("feature", "value");
//
//        LoggingCapabilities logging = new LoggingCapabilities();
//        PromptCapabilities prompts = new PromptCapabilities();
//        ResourceCapabilities resources = new ResourceCapabilities();
...
//        assertEquals(experimental, result.getCapabilities().getExperimental());
//        Gson gson = new Gson();
...
//    }
    ...
    public void testInitializeWithCapabilitiesParameters() {
        ...
        Gson gson = new Gson();
        String out = gson.toJson(jsonResponse, JSONResponse.class);
        String check = "{\"id\":0,\"jsonrpc\":\"2.0\",\"result\":{\"protocolVersion\":\"1.0\",\"capabilities\":{\"tools\":{\"listChanged\":true}},\"serverInfo\":{\"name\":\"TestServer\",\"version\":\"2.0\"}}}";
